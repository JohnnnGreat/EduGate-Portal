...
const HostelComponent = () => {
   ...
   return (
      <div className="p-[1rem]">
         <div className="bg-white rounded-[20px] p-[2rem]">
            ...
            <p className="text-[#000]/40 text-[.9rem] my-[.5rem] leading-relaxed">
               Welcome to the Hostel Accommodation Section. Here, you can apply for a hostel, check
               your allocation status, make payments, and manage any accommodation-related matters.
               Please ensure you read all instructions carefully to secure your preferred
               accommodation.
            </p>
